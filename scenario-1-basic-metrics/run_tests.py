#!/usr/bin/env python3
"""
Performance test runner for Scenario 1: Basic Metrics (Learning Phase)

This script runs tests for both .NET and Python Agent Framework implementations
using basic performance metrics for educational/learning purposes.

Workflow:
1. Configure environment variables for tests
2. Clean up old metrics files
3. Run specified agent tests (.NET and Python)
4. Generate basic comparison reports

Note: This is Scenario 1 - basic metrics for learning what NOT to do.
For production use, see Scenario 2 (enhanced metrics).
